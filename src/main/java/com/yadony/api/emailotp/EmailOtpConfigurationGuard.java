...
public class EmailOtpConfigurationGuard implements HealthIndicator {
    ...
    void reportConfigurationAtStartup() {
        ...
        if (activeProfiles.contains("prod")) {
            log.error("❌ yadony.email.resend-api-key est VIDE en production : aucun code OTP ne "
        ...
        log.warn("⚠️  yadony.email.resend-api-key est VIDE — aucun email ne sera réellement envoyé. "
