    ...
    public ReportEntity createReport(String firebaseUid,
        ...
        for (String key : keys) {
            if (key == null || !key.startsWith(ownPrefix)) {
                throw new DonyBusinessException(HttpStatus.FORBIDDEN, "photo-not-owned",
