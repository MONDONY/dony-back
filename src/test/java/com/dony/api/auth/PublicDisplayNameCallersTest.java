...
class PublicDisplayNameCallersTest {
    ...
    private static final List<String> ALLOWED_FULL_NAME_CONTEXTS = List.of(
            "com/dony/api/admin/",
            "com/dony/api/export/",
            "com/dony/api/payments/FiscalExportService",
            "com/dony/api/referral/ReferralService",
            "com/dony/api/common/MatchingTextUtil",
            "com/dony/api/auth/UserEntity",
            "com/dony/api/auth/AuthService",
            "com/dony/api/auth/UserRoleService"
    );
    ...
    void noHandRolledDisplayNameOutsideAdminAndExports() throws Exception {
        ...
        java.nio.file.Path root = java.nio.file.Path.of("src/main/java/com/dony/api");
