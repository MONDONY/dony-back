    ...
    class SearchTests {
        ...
        void search_noFilters_sortByDate_returnsPage() {
            ...
            Page<?> result = announcementService.searchAnnouncements(
                    null, null, null, null, null, null, null, null, null, null, null, null, null, "date", "asc", PageRequest.of(0, 10));
        ...
        void search_allFilters_sortByPriceDesc_returnsPage() {
            ...
            Page<?> result = announcementService.searchAnnouncements(
                    ...
                    BigDecimal.valueOf(5), null, null, null, null, null, null, null, null, "price", "desc", PageRequest.of(0, 10));
        ...
        void search_travelerLastNameOnly_displayName() {
            ...
            Page<?> result = announcementService.searchAnnouncements(
                    null, null, null, null, null, null, null, null, null, null, null, null, null, null, "asc", PageRequest.of(0, 10));
        ...
        void search_travelerNotFound_profileIsNull() {
            ...
            Page<?> result = announcementService.searchAnnouncements(
                    "Paris", null, null, null, null, null, null, null, null, null, null, null, null, "date", "desc", PageRequest.of(0, 10));
        ...
        void search_travelerNeitherFirstNorLastName_displayNameNull() {
            ...
            assertThatNoException().isThrownBy(() -> announcementService.searchAnnouncements(
                    null, "Dakar", LocalDate.now(), null, null, null, null, null, null, null, null, null, null, "price", "asc", PageRequest.of(0, 10)));
        }
    }
}
