...
/**
 * Contrat de délégation : le listener ne porte plus la mécanique de remboursement,
 * il délègue à {@link RefundProcessor}. La logique PENDING/ESCROW/claim/refund est
 * testée dans {@code RefundProcessorTest}.
 */
...
class BidRejectedEventListenerTest {
    ...
    @BeforeEach
    void setUp() {
        listener = new BidRejectedEventListener(paymentRepository, refundProcessor);
    }
