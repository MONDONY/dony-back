...
/**
 * Support DonyPaymentSheet (sheet de paiement custom) :
...
class PaymentSheetSupportTest {
    ...
    void updateSavePaymentMethod_throws403_whenNotOwner() {
        ...
        try (MockedStatic<PaymentIntent> piStatic = mockStatic(PaymentIntent.class)) {
            ...
            assertThat(((DonyBusinessException) thrown).getErrorCode()).isEqualTo("forbidden");
        }
    }
    ...
    void updateSavePaymentMethod_throws409_whenIntentAlreadyConfirmed() {
        ...
        try (MockedStatic<PaymentIntent> piStatic = mockStatic(PaymentIntent.class)) {
            ...
            assertThat(thrown).isInstanceOf(DonyBusinessException.class);
            assertThat(((DonyBusinessException) thrown).getErrorCode()).isEqualTo("intent-not-editable");
        }
    }
}
