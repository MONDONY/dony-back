...
class StripeConnectSpikeTest {
    ...
    void spike_01_createExpressConnectedAccount() throws Exception {
        AccountCreateParams params = AccountCreateParams.builder()
                ...
                .setCountry("FR")
                .setEmail("voyageur-test@yadony.app")
    ...
    void spike_02_generateOnboardingLink() throws Exception {
        ...
        AccountLinkCreateParams params = AccountLinkCreateParams.builder()
                ...
                .setRefreshUrl("https://yadony.app/payments/onboarding/refresh")
                .setReturnUrl("https://yadony.app/payments/onboarding/return")
    ...
    void spike_03_createPaymentIntentWithEscrow() throws Exception {
        ...
        System.out.println("   Commission yadony: " + commissionCents / 100.0 + "€ (12%)");
