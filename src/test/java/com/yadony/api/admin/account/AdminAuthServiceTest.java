...
class AdminAuthServiceTest {
    ...
    void testSupport_hasRoleAdminAndPaymentView_notPaymentRefund() {
        AdminUserEntity entity = buildEntity("uid-support", "support@yadony", AdminRole.SUPPORT, AdminStatus.ACTIVE);
    ...
    void testSuperAdmin_hasAllRolesAndAdminManage() {
        AdminUserEntity entity = buildEntity("uid-super", "superadmin@yadony", AdminRole.SUPER_ADMIN, AdminStatus.ACTIVE);
    ...
    void testSuperAdmin_hasAllPermissions() {
        AdminUserEntity entity = buildEntity("uid-super2", "root@yadony", AdminRole.SUPER_ADMIN, AdminStatus.ACTIVE);
    ...
    void testDisabledAccount_returnsEmpty() {
        AdminUserEntity entity = buildEntity("uid-disabled", "disabled@yadony", AdminRole.SUPPORT, AdminStatus.DISABLED);
    ...
    void testEvict_resolvesFirebaseUid() {
        ...
        AdminUserEntity entity = buildEntity("uid-evict", "evict@yadony", AdminRole.ADMIN, AdminStatus.ACTIVE);
    ...
    void testAdmin_hasRoleAdminNotSuperAdmin() {
        AdminUserEntity entity = buildEntity("uid-admin", "admin@yadony", AdminRole.ADMIN, AdminStatus.ACTIVE);
