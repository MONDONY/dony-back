 ...
 * le vrai projet Firebase (yadony-36cb2) via le service account de dev et crée un
...
@DisplayName("FirebaseContactService — contre le vrai Firebase (yadony-36cb2)")
class FirebaseContactLiveIT {
    ...
    private final String email = "live-it-" + System.nanoTime() + "@yadony-live-test.invalid";
    ...
    void findUid_resolvesRealAccount() {
        ...
        assertThat(service.findUidByEmail("absent-" + System.nanoTime() + "@yadony-live-test.invalid"))
                .isEmpty();
    }
    ...
    void updateEmail_writesThroughAndEvicts() {
        ...
        String newEmail = "updated-" + System.nanoTime() + "@yadony-live-test.invalid";
